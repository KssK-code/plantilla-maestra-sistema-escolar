// EDGE FUNCTION TEMPLATE - REENVÍO DE COMPROBANTES CON REIMPRESIÓN
// Copiar este código completo a Supabase Edge Functions
...
serve(async (req) => {
  ...
  try {
    ...
    const emailResponse = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'admin@avanzasystemcdobregon.cloud', // PERSONALIZAR: Cambiar por tu dominio
        to: [student.email],
        subject: `Comprobante de Pago - ${payment.concept}`,
        html: receiptHtml,
        reply_to: 'admin@avanzasystemcdobregon.cloud', // PERSONALIZAR: Cambiar por tu dominio
      }),
    })
